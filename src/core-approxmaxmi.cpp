...
void AllocateProblem(rapidmic_data *micData, double alpha)
{
	// Auxiliar variables
	double nAlpha;
	int Gy_max;
	...
	micData -> score = new rapidmic_score;
...
*/
void FixXpartition(rapidmic_data *micData, double clumps, int indexP, double *I, int *Pm, int *Qm)
{
	int p;
	int q;
	int j;
...
Input:
	...
	Pm(OUT) : the map P computed by GetSuperclumpsPartition
*/
void FixYpartition(rapidmic_data *micData, double clumps, int indexP, double *I, int *Pm, int *Qm)
{
	int p;
	int q;
	int j;
...
rapidmic_score *ComputeScoreMIC(rapidmic_data *micData, double clumps)
{
	double *it;
	int *qM_s;
	int *qM;
...
void DeallocateProblem(rapidmic_data *micData)
{
	int i;
...
double ApproxMaxMI(config params, double *varX, double *varY, int n)
{
	...
	// Fill rapidmic_data structure store the processed data
	rapidmic_data micData;
	micData.x = varX;
	micData.y = varY;
	micData.n = n;
